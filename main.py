...
window.configure(background='#9A9ACD')
...
def manually_fill():
    ...
    sb.geometry('580x320')
    sb.configure(background='#9A9ACD')
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="red", width=9, height=1, activebackground="Red",
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            MFW.configure(background='#9A9ACD')
            ...
            def err_screen1():
                ...
                errsc2.configure(background='#9A9ACD')
                Label(errsc2, text='Please enter Student & Enrollment!!!', fg='black', bg='white',
                      font=('times', 16, ' bold ')).pack()
                Button(errsc2, text='OK', command=del_errsc2, fg="black", bg="red", width=9, height=1,
            ...
            ENR = tk.Label(MFW, text="Enter Student ID", width=15, height=2, fg="black", bg="#9A9ACD",
                           font=('times', 15))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Student name", width=15, height=2, fg="black", bg="#9A9ACD",
                                font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/GIGABYTE/PycharmProjects/Face-Recognition-Attendance-System/Attendance/Manually Attendance/'+DB_table_name+'.csv'
                ...
                root.configure(background='#9A9ACD')
            ...
            Notifi = tk.Label(MFW, text="CSV created Successfully", bg="red", fg="white", width=33,
                              height=2, font=('times', 19, 'bold'))

            c1ear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="black", bg="#9A9ACD", width=10,
                                     height=1,
                                     activebackground="white", font=('times', 15, ' bold '))
            c1ear_enroll.place(x=690, y=100)

            c1ear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="black", bg="#9A9ACD", width=10,
                                      height=1,
                                      activebackground="white", font=('times', 15, ' bold '))
    ...
    SUB = tk.Label(sb, text="Enter Subject : ", width=15, height=2,
                   fg="black", bg="#9A9ACD", font=('times', 15, ' bold '))
    SUB.place(x=30, y=100)

    global SUB_ENTRY

    SUB_ENTRY = tk.Entry(sb, width=15, bg="white",
                         fg="black", font=('times', 23))
    SUB_ENTRY.place(x=250, y=105)

    fill_manual_attendance = tk.Button(sb, text="Fill Attendance", command=fill_attendance, fg="black", bg="SkyBlue1", width=15, height=2,
...
def err_screen():
    ...
    sc1.title('Warning!!')
    sc1.configure(background='#9A9ACD')
    Label(sc1, text='Student ID & Name required!', fg='black',
          bg='white', font=('times', 16)).pack()
    Button(sc1, text='OK', command=del_sc1, fg="black", bg="red", width=9,
...
def err_screen1():
    ...
    sc2.title('Warning!!')
    sc2.configure(background='#9A9ACD')
    Label(sc2, text='Please enter your subject name!', fg='black',
          bg='white', font=('times', 16)).pack()
    Button(sc2, text='OK', command=del_sc2, fg="black", bg="red", width=9,
           height=1, activebackground="Red", font=('times', 15, ' bold ')).place(x=90, y=50)
    ...
    if l1 == '':
        ...
        try:
            ...
            Notification.configure(
                text=res, bg="red", width=50, font=('times', 18, 'bold'))
            Notification.place(x=330, y=500)
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                Notifica.configure(text=M, bg="red", fg="white",
                ...
                root.configure(background='#9A9ACD')
                cs = 'C:/Users/GIGABYTE/PycharmProjects/Face-Recognition-Attendance-System/' + fileName
    ...
    windo.configure(background='#9A9ACD')
    Notifica = tk.Label(windo, text="Attendance filled Successfully", bg="red", fg="white", width=33,
    ...
    tx = tk.Entry(windo, width=15, bg="white",
                  fg="black", font=('times', 23))
    tx.place(x=250, y=105)

    fill_a = tk.Button(windo, text="Fill Attendance", fg="black", command=Fillattendances, bg="SkyBlue1", width=15, height=2,
                       activebackground="black", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    win.configure(background='#9A9ACD')
    ...
    def log_in():
        ...
        if username == 'admin':
            if password == 'admin123':
                ...
                import tkinter
                import os
                os.startfile(r'C:\Users\GIGABYTE\PycharmProjects\Face-Recognition-Attendance-System\Attendance')
                root = tkinter.Tk()
                root.title("Student Details")
                root.configure(background='#9A9ACD')

                cs = 'C:/Users/GIGABYTE/PycharmProjects/Face-Recognition-Attendance-System/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    Nt = tk.Label(win, text="Attendance filled Successfully", bg="red", fg="white", width=40,
                  height=2, font=('times', 19, 'bold'))
    # Nt.place(x=120, y=350)

    un = tk.Label(win, text="Enter username : ", width=15, height=2, fg="black", bg="#9A9ACD",
                  font=('times', 15, ' bold '))
    un.place(x=30, y=50)

    pw = tk.Label(win, text="Enter password : ", width=15, height=2, fg="black", bg="#9A9ACD",
                  font=('times', 15, ' bold '))
    pw.place(x=30, y=150)
    ...
    c0 = tk.Button(win, text="Clear", command=c00, fg="white", bg="#9A9ACD", width=10, height=1,
                   activebackground="white", font=('times', 15, ' bold '))
    c0.place(x=690, y=55)

    c1 = tk.Button(win, text="Clear", command=c11, fg="white", bg="#9A9ACD", width=10, height=1,
                   activebackground="white", font=('times', 15, ' bold '))
    c1.place(x=690, y=155)

    Login = tk.Button(win, text="Log in", fg="black", bg="SkyBlue1", width=20,
                      height=2,
...
def trainimg():
    ...
    try:
        ...
        Notification.configure(text=q, bg="red",
                               width=50, font=('times', 18, 'bold'))
        Notification.place(x=330, y=500)

    res = "Model Trained"  # +",".join(str(f) for f in Id)
    Notification.configure(text=res, bg="red",
                           width=50, font=('times', 18, 'bold'))
    Notification.place(x=330, y=500)
...
message = tk.Label(window, text="Face Recognition based Attendance System", bg="#9A9ACD", fg="white", width=50,
                   height=3, font=('times', 30, ' bold '))

message.place(x=20, y=10)

message2 = tk.Label(window, text="Register", bg="#9A9ACD", fg="black", width=20,
                   height=1, font=('times', 20, ' normal '))

message2.place(x=500, y=160)

lbl = tk.Label(window, text="Enter Student ID : ", width=20, height=2,
               fg="black", bg="#9A9ACD", font=('times', 15, 'bold'))
...
txt.place(x=351, y=220)

lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="black",
                bg="#9A9ACD", height=2, font=('times', 15, ' bold '))
lbl2.place(x=500, y=210)

txt2 = tk.Entry(window, width=20, bg="white",
                fg="black", font=('times', 15))
txt2.place(x=700, y=220)

message2 = tk.Label(window, text="Attendance", bg="#9A9ACD", fg="black", width=20,
                   height=1, font=('times', 20, ' normal '))

message2.place(x=500, y=340)
...
AP = tk.Button(window, text="Admin", command=admin_panel, fg="black",
               bg="SkyBlue1", width=20, height=1, activebackground="white", font=('times', 15, ' bold '))
AP.place(x=990, y=610)
